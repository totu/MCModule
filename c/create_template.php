		...
		<div id="body">
			<div id="tabs">
				...
				<div id="padder">
					...
					<label for="title">Name: </label><input style='position:relative;left:10px' type="textbox" name='title' value='Newsletter Title'><br><br>
					
					<label for="html">HTML:</label><textarea name="html" id="html" cols="30" rows="10">Some pretty html content.
					</textarea>
